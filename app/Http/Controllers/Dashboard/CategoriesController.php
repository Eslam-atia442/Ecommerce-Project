...
class CategoriesController extends Controller
{
    ...
    public function update($id, MainCategoryRequest $request)
    {
        try {
            ...
            return redirect()->route('dashboard.maincategories')->with(['success' => 'تم ألتحديث بنجاح']);
        } catch (\Exception $ex) {

            return redirect()->route('dashboard.maincategories')->with(['error' => 'حدث خطا ما برجاء المحاوله لاحقا']);
        }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return redirect()->route('dashboard.maincategories')->with(['success' => 'تم  الحذف بنجاح']);
