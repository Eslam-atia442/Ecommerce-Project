                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="manage_stock" class="select2 form-control" id="manageStock">
                                                                <optgroup label="من فضلك أختر النوع ">
                                                                    <option value="1" @if($products -> manage_stock == 1)selected @endif >اتاحة التتبع</option>
                                                                    <option value="0" @if($products -> manage_stock == 0)selected @endif>عدم اتاحه التتبع</option>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="in_stock" class="select2 form-control" >
                                                                <optgroup label="من فضلك أختر  ">
                                                                    <option value="1" @if($products -> in_stock == 1)selected @endif >متاح</option>
                                                                    <option value="0"@if($products -> in_stock == 0)selected @endif >غير متاح </option>
                                                                </optgroup>
                                                            </select>
                                                            @error('in_stock')
                                                            <span class="text-danger"> {{$message}}</span>
                                                    ...
                                                    <div class="col-md-6" style="@if($products -> manage_stock == 1)display:none @endif>"  id="qtyDiv">
                                                        <div class="form-group">
