<div class="main-menu menu-fixed menu-light menu-shadow expanded" data-scroll-to-active="true" style="touch-action: none; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
    <div class="main-menu-content ps ps--active-y">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-qrcode"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.brands.create')}}" data-i18n="nav.dash.crypto">أضافة ماركه جديده</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-tag"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.tags.create')}}" data-i18n="nav.dash.crypto">اضافه علامات</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-cube"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.create.Product.info')}}" data-i18n="nav.dash.crypto">اضافه منتج</a>
                    </li>
                </ul>
            </li>


            <li class="nav-item"><a href=""><i class="la la-shirtsinbulk"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.create.attribute.info')}}" data-i18n="nav.dash.crypto">اضافه خاصيه</a>
                    </li>
                </ul>
            </li>


            <li class="nav-item"><a href=""><i class="la la-la la-object-ungroup"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">اختيارات  </span>
                    <span
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('admin.create.options')}} " data-i18n="nav.dash.crypto">أضافة
                            متجر </a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">وسائل توصيل</a>
                        <ul class="menu-content">

                            <li><a class="menu-item" href="{{route('edit.shipping.method','free')}}">توصيل مجاني</a>
                            </li>
                            <li><a class="menu-item" href="{{route('edit.shipping.method','inner')}}"
                                   data-i18n="nav.templates.vert.compact_menu">توصيل داحلي</a>
                            </li>
