                                ...
                                <div class="products product_list grid row" data-default-view="grid">
                                    @isset($products)
                                        @foreach($products as $product)
                                                ...
                                                <div class="product-miniature js-product-miniature item-one"
                                                        ...
                                                        <a href="{{route('product.details',$product -> slug)}}"
                                                           class="thumbnail product-thumbnail two-image">
                                                            ...
                                                            <img class="img-fluid image-secondary"
                                                                 src="{{asset('assets/images/products').'/'.$product -> images[1] -> photo ?? ''}}"
                                                                 alt=""
                                                                 data-full-size-image-url="{{asset('assets/images/products').'/'.$product -> images[1] -> photo ?? ''}}"
                                                                 width="600" height="600">
                                                        </a>
                                                    ...
                                                    <div class="product-description">
                                                        ...
                                                        <div class="product-buttons d-flex justify-content-center"
                                                            ...
                                                            <a class="addToWishlist removeFromWishlist wishlistProd_22" href="#"
                                            ...
                                            @include('front.includes.products-details',$product)
                                        @endforeach
                                    @endisset
                                </div>
                            </div>
